...
-- 일부 값이 너무 커서 열 길이를 줄일 수 없음
	--> 이미 저장된 값 보다 작은 크기의 자료형으로 변경 불가!!!!!
...
-- 최소 한 개 이상의 컬럼을 가져야 한다!!!!!

-->  ALTER TABLE 테이블명 DROP COLUMN 삭제할컬럼명;

-- DDL : CREATE, ALTER, DROP 	  - 객체 구조 다루기
-- DML : INSERT, UPDATE, DELETE - 값 조작
...
-- [작성법]
-- DROP TABLE 테이블명 [CASCADE CONSTRAINTS]; -- 종속된 제약조건을 지워라!
