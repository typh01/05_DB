...
INSERT INTO "MEMBER"
VALUES('MEM03', '1Q2W3E4R', '박철수', '970101-1765432', DEFAULT);
 ...
 * 
 * 2) 테이블 레벨 설정 : 테이블 생성 구문 제일 밑에 작성해서 제약조건 추가 - 자주 씀
...
--> UNIQUE 복합키가 설정된 모드느 컬럼의 값이 같으면 중복으로 판단
	--> 한 컬럼의 값이라도 다르면 중복 X
...
CREATE TABLE USER_USED_FK(
  USER_NO NUMBER PRIMARY KEY, -- FK 제약조건으로 참조할 KEY
  USER_ID VARCHAR2(20) UNIQUE,
  USER_PWD VARCHAR2(30) NOT NULL,
  USER_NAME VARCHAR2(30),
  GENDER VARCHAR2(10),
  ...
  FOREIGN KEY(GRADE_CODE) -- 10, 20, 30만 작성 가능!
  REFERENCES USER_GRADE(GRADE_CODE) 
  -- 현재 테이블의 GRADE_CODE 컬럼에 저장할 값은
  -- USER_GRADE 테이블의 GRADE_CODE 컬럼에 저장된 값만 가능!
  -- == 참조
...
-- 무결성 제약조건(KH12_PTH.GRADE_CODE_FK1)이 위배되었습니다
-- - 부모 키가 없습니다
...
FROM
	USER_USED_FK CHILD
LEFT JOIN -- 서로 다른 두 테이블을 연결시키는 것 
	USER_GRADE PARENT 
...
-- 체크 제약조건(KH12_PTH.CHECK_SCORE)이 위배되었습니다
...
DROP TABLE USER_TEST; -- 잘못 만들었을 때 한 번 씩 실행
...
CREATE TABLE USER_TEST(
	...
	PNO VARCHAR2(18) CONSTRAINT UK_PNO UNIQUE CONSTRAINT NN_PNO NOT NULL,
...
-- 정상적인 샘플 데이터
INSERT INTO USER_TEST VALUES (1, 'user1', 'password1', '123456-1234567', '남', '010-1234-5678', 'Seoul', 'Y');
INSERT INTO USER_TEST VALUES (2, 'user2', 'password2', '234567-2345678', '여', '010-2345-6789', 'Busan', 'N');
INSERT INTO USER_TEST VALUES (3, 'user3', 'password3', '345678-3456789', '남', '010-3456-7890', 'Incheon', 'Y');
INSERT INTO USER_TEST VALUES (4, 'user4', 'password4', '456789-4567890', '여', '010-4567-8901', 'Daegu', 'N');
INSERT INTO USER_TEST VALUES (5, 'user5', 'password5', '567890-5678901', '남', '010-5678-9012', 'Gwangju', 'Y');

SELECT * FROM USER_TEST;

-- 모든 제약 조건을 위배하는 데이터
INSERT INTO USER_TEST VALUES (6, NULL, NULL, '123456-1234567', 'X', '010-9999-9999', 'Seoul', 'Z');
...
CREATE TABLE USER_TEST(
  ...
  GENDER CHAR(3), -- 테이블 레벨과 컬럼 레벨이 똑같음
  PHONE CHAR(13),
