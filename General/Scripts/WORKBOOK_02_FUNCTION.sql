...
SELECT 
	STUDENT_NO 학번, 
	STUDENT_NAME 이름, 
	TO_CHAR(ENTRANCE_DATE, 'YYYY-MM-DD') "입학 년도" 
FROM
	TB_STUDENT 
WHERE 
	DEPARTMENT_NO = 002
...
SELECT 
	...
	FLOOR((MONTHS_BETWEEN(SYSDATE, '19'||TO_DATE(SUBSTR(PROFESSOR_SSN,1,6)))) / 12) AS "나이"
FROM
	TB_PROFESSOR
WHERE 
