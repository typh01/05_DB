...
-- 그룹으로 묶은 값에 대해서 SELECT절에서 "그룹함수"를 사용함

-- 그룹 함수는 단 한개의 결과 값만 산출하기 때문에 
-- 그룹이 여러 개일 경우 오류 발생
...
SELECT 
	...
	-- COUNT(컬럼명) : 컬럼 값이  NULL인 행 제외하고 COUNT
FROM 
	EMPLOYEE 
GROUP BY
	DEPT_CODE
